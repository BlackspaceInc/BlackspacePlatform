...
if [[ "${USE_TEST_REPO:-"false"}" == "true" ]]; then
  PUBLIC_URL="https://Blackspace-helm-repo-tests.s3.amazonaws.com/helm/$CHANNEL"
  AWS_REPO_URL="s3://Blackspace-helm-repo-tests/helm/$CHANNEL"
else
