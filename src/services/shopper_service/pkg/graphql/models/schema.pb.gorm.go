...
type CompanyORM struct {
	...
	IsActive                    bool
	Media                       *MediaORM `gorm:"foreignkey:CompanyId;association_foreignkey:Id;preload:true"`
	MerchantType                int32
	Password                    string
	ServicesManagedByBlackspace int32
	SubscribedTopics            *TopicsORM `gorm:"foreignkey:CompanyId;association_foreignkey:Id;preload:true"`
}
...
func (m *Company) ToORM(ctx context.Context) (CompanyORM, error) {
	...
	to.MerchantType = int32(m.MerchantType)
	to.ServicesManagedByBlackspace = int32(m.ServicesManagedByBlackspace)
...
func (m *CompanyORM) ToPB(ctx context.Context) (Company, error) {
	...
	to.BusinessStage = m.BusinessStage
	to.MerchantType = MerchantType(m.MerchantType)
	to.ServicesManagedByBlackspace = ServicesManagedByBlackspace(m.ServicesManagedByBlackspace)
	if m.SubscribedTopics != nil {
...
func DefaultCreateCompany(ctx context.Context, in *Company, db *gorm1.DB) (*Company, error) {
	if in == nil {
...
// DefaultReadCompany executes a basic gorm read call
func DefaultReadCompany(ctx context.Context, in *Company, db *gorm1.DB) (*Company, error) {
	if in == nil {
		return nil, errors1.NilArgumentError
	}
	ormObj, err := in.ToORM(ctx)
	...
	if db, err = gorm2.ApplyFieldSelection(ctx, db, nil, &CompanyORM{}); err != nil {
		return nil, err
	}
...
func DefaultDeleteCompany(ctx context.Context, in *Company, db *gorm1.DB) error {
	if in == nil {
...
func DefaultDeleteCompanySet(ctx context.Context, in []*Company, db *gorm1.DB) error {
	if in == nil {
		return errors1.NilArgumentError
	}
	var err error
...
type CompanyORMWithBeforeDeleteSet interface {
	BeforeDeleteSet(context.Context, []*Company, *gorm1.DB) (*gorm1.DB, error)
}
type CompanyORMWithAfterDeleteSet interface {
	AfterDeleteSet(context.Context, []*Company, *gorm1.DB) error
}

// DefaultStrictUpdateCompany clears first level 1:many children and then executes a gorm update call
func DefaultStrictUpdateCompany(ctx context.Context, in *Company, db *gorm1.DB) (*Company, error) {
	if in == nil {
	...
	filterMedia.CompanyId = new(uint32)
	*filterMedia.CompanyId = ormObj.Id
	...
	filterSubscribedTopics.CompanyId = new(uint32)
	*filterSubscribedTopics.CompanyId = ormObj.Id
...
func DefaultPatchCompany(ctx context.Context, in *Company, updateMask *field_mask1.FieldMask, db *gorm1.DB) (*Company, error) {
	if in == nil {
		return nil, errors1.NilArgumentError
	}
	var pbObj Company
...
type CompanyWithBeforePatchRead interface {
	BeforePatchRead(context.Context, *Company, *field_mask1.FieldMask, *gorm1.DB) (*gorm1.DB, error)
}
type CompanyWithBeforePatchApplyFieldMask interface {
	BeforePatchApplyFieldMask(context.Context, *Company, *field_mask1.FieldMask, *gorm1.DB) (*gorm1.DB, error)
}
type CompanyWithBeforePatchSave interface {
	BeforePatchSave(context.Context, *Company, *field_mask1.FieldMask, *gorm1.DB) (*gorm1.DB, error)
}
type CompanyWithAfterPatchSave interface {
	AfterPatchSave(context.Context, *Company, *field_mask1.FieldMask, *gorm1.DB) error
}

// DefaultPatchSetCompany executes a bulk gorm update call with patch behavior
func DefaultPatchSetCompany(ctx context.Context, objects []*Company, updateMasks []*field_mask1.FieldMask, db *gorm1.DB) ([]*Company, error) {
...
func DefaultApplyFieldMaskCompany(ctx context.Context, patchee *Company, patcher *Company, updateMask *field_mask1.FieldMask, prefix string, db *gorm1.DB) (*Company, error) {
	if patcher == nil {
		return nil, nil
	} else if patchee == nil {
		return nil, errors1.NilArgumentError
...
func DefaultListCompany(ctx context.Context, db *gorm1.DB) ([]*Company, error) {
	in := Company{}
	ormObj, err := in.ToORM(ctx)
	if err != nil {
		return nil, err
	...
	db, err = gorm2.ApplyCollectionOperators(ctx, db, &CompanyORM{}, &Company{}, nil, nil, nil, nil)
	if err != nil {
		return nil, err
	}
...
type CompanyORMWithAfterListFind interface {
	AfterListFind(context.Context, *gorm1.DB, *[]CompanyORM) error
}
