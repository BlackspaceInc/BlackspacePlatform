...
type AddressInput struct {
	...
	City          *string           `json:"City"`
	State         *string           `json:"State"`
	Birthdate     *DateOfBirthInput `json:"birthdate"`
}
...
type Company struct {
	...
	TypeOfBusiness              *BusinessType                `json:"typeOfBusiness"`
	...
	PaymentDetails              *PaymentProcessingMethods    `json:"paymentDetails"`
	ServicesManagedByBlackspace *ServicesManagedByBlackspace `json:"servicesManagedByBlackspace"`
	FounderAddress              *Address                     `json:"founderAddress"`
	SubscribedTopics            *Topics                      `json:"subscribedTopics"`
}
...
type PaymentProcessingMethodsInput struct {
	PaymentOptions []*PaymentOptions `json:"paymentOptions"`
	Medium         []*PaymentMedium  `json:"medium"`
}
