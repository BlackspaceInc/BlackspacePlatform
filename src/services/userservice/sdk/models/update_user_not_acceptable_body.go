...
// UpdateUserNotAcceptableBody UpdateUserNotAcceptableBody UpdateUserNotAcceptableBody update user not acceptable body
...
func (m *UpdateUserNotAcceptableBody) validateError(formats strfmt.Registry) error {
