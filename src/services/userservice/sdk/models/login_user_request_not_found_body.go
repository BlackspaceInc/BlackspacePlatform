...
// LoginUserRequestNotFoundBody LoginUserRequestNotFoundBody login user request not found body
...
func (m *LoginUserRequestNotFoundBody) validateError(formats strfmt.Registry) error {
