...
// UpdateUserBadRequestBody UpdateUserBadRequestBody update user bad request body
...
func (m *UpdateUserBadRequestBody) validateError(formats strfmt.Registry) error {
