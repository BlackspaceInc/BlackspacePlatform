...
// DeleteUserBadRequestBody DeleteUserBadRequestBody DeleteUserBadRequestBody DeleteUserBadRequestBody delete user bad request body
...
func (m *DeleteUserBadRequestBody) validateError(formats strfmt.Registry) error {
