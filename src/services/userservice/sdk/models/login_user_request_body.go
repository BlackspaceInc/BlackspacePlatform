...
// LoginUserRequestBody LoginUserRequestBody login user request body
...
func (m *LoginUserRequestBody) validatePassword(formats strfmt.Registry) error {
...
func (m *LoginUserRequestBody) validateUsername(formats strfmt.Registry) error {
