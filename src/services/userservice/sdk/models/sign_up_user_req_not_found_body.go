...
// SignUpUserReqNotFoundBody SignUpUserReqNotFoundBody sign up user req not found body
...
func (m *SignUpUserReqNotFoundBody) validateError(formats strfmt.Registry) error {
