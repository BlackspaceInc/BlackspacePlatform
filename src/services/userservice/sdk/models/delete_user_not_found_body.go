...
// DeleteUserNotFoundBody DeleteUserNotFoundBody DeleteUserNotFoundBody delete user not found body
...
func (m *DeleteUserNotFoundBody) validateError(formats strfmt.Registry) error {
