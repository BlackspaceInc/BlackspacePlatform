...
// UpdateUserForbiddenBody UpdateUserForbiddenBody UpdateUserForbiddenBody UpdateUserForbiddenBody update user forbidden body
...
func (m *UpdateUserForbiddenBody) validateError(formats strfmt.Registry) error {
