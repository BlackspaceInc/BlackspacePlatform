...
// LoginUserRequestInternalServerErrorBody LoginUserRequestInternalServerErrorBody login user request internal server error body
...
func (m *LoginUserRequestInternalServerErrorBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *LoginUserRequestInternalServerErrorBody) validateError(formats strfmt.Registry) error {
