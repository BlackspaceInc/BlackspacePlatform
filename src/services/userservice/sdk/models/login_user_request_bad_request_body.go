...
// LoginUserRequestBadRequestBody LoginUserRequestBadRequestBody LoginUserRequestBadRequestBody login user request bad request body
...
func (m *LoginUserRequestBadRequestBody) validateError(formats strfmt.Registry) error {
