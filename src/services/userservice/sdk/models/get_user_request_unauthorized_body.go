...
// GetUserRequestUnauthorizedBody GetUserRequestUnauthorizedBody get user request unauthorized body
...
func (m *GetUserRequestUnauthorizedBody) validateError(formats strfmt.Registry) error {
