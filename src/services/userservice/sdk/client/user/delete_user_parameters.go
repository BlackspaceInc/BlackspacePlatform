...
// WithResult adds the result to the delete user params
func (o *DeleteUserParams) WithResult(result uint32) *DeleteUserParams {
	o.SetResult(result)
	return o
}

// SetResult adds the result to the delete user params
func (o *DeleteUserParams) SetResult(result uint32) {
	o.Result = result
}
...
func (o *DeleteUserParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	// query param result
	qrResult := o.Result
	qResult := swag.FormatUint32(qrResult)
	if qResult != "" {
