...
// WithUserAccountID adds the userAccountID to the update user params
func (o *UpdateUserParams) WithUserAccountID(userAccountID *uint32) *UpdateUserParams {
	o.SetUserAccountID(userAccountID)
	return o
}

// SetUserAccountID adds the userAccountId to the update user params
func (o *UpdateUserParams) SetUserAccountID(userAccountID *uint32) {
